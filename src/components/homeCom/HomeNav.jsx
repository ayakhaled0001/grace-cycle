...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <>
      <nav className={`fixed z-50 ${backgroundColor} top-0 flex justify-around m-auto h-24 lgHome:py-5 minScreen:py-3 minScreen:h-20 w-full font-nunitoBold  minScreen:justify-between minScreen:px-3`}>
        ...
        <ul className="flex items-center justify-center w-[50%] ml-5 minScreen:hidden lgHome:flex">
          ...
          <li className="mr-20">
            <button onClick={handleNavigateServices} className="text-lg hover:text-lightBrownYellow">
              Services
            </button>
          </li>
          <li className="mr-20">
            <NavLink to="/about" className={`text-lg hover:text-lightBrownYellow`}>
              About us
            </NavLink>
          </li>
          <li className="mr-20">
            <NavLink to="/contact" className={`text-lg hover:text-lightBrownYellow`}>
              Contact us
            </NavLink>
          </li>
        </ul>
        ...
        <button onClick={toggleMenu} className="lgHome:hidden text-3xl focus:outline-none">
          ☰
        </button>
      </nav>
