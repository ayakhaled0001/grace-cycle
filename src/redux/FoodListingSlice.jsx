...
const BaseUrlListing = "https://grace-cyle.runasp.net/api/Foods";
...
const foodListingSlice = createSlice({
  ...
  reducers: {
    ...
    updateFavoriteStatus: (state, action) => {
      const { foodId, isFavourite } = action.payload;
      if (state.id === foodId) {
...
export const { clearFoodListing, updateFavoriteStatus } =
  foodListingSlice.actions;
