...
const MyListings = () => {
  ...
  const fetchVendorBags = async () => {
    ...
    try {
      ...
      // Try different endpoints to find vendor bags
      let response;
      try {
        // First try the general bags endpoint with auth
        response = await axios.get(
          "https://gracecycleapi.azurewebsites.net/api/web/home/bags",
          {
            headers: {
        ...
        // If that fails, try the discover bags endpoint
        response = await axios.get(
