function MainDishes() {
  return (
    <section className="w-10/12 mx-auto bg-semiDarkBeige my-5">
      ...
      <div className="m-3 w-3/12 font-sans border border-stone-700 rounded-xl overflow-hidden">
        ...
        <div className="p-2">
          ...
          <button className="text-center w-full p-2 border-2 border-btnsGreen rounded-xl text-btnsGreen font-">
            Add to Cart
          </button>
        </div>
      </div>
