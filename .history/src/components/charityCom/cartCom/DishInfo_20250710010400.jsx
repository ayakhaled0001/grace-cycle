  ...
  const handleToggleFavorite = (itemId, isCurrentlyFavorited) => {
    ...
    if (itemType === "dish" && id) {
      ...
      if (!isCurrentlyFavorited) {
        // The FoodSlice will handle adding it to favoriteFoods
        console.log("Adding food to favorites:", foodData);
      }
    } else {
      // For other cases (fallback data, bags), use the regular toggle
      dispatch(toggleFavorite({ foodId: itemId, isCurrentlyFavorited }));
    }
  };
