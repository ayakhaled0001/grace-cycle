...
function DishInfo({ itemId, itemType = "dish", showShoppingCart = true }) {
  ...
  // Fetch vendors data when component mounts for vendor pages
  useEffect(() => {
    if (itemType === "vendor") {
      dispatch(getVendors());
    }
  ...
  if (itemType === "vendor") {
    ...
    console.log("Searching for vendor:", decodedItemId);
    console.log(
      "Available vendors:",
    ...
    const vendor = vendors.find(
      (v) => v.displayName.toLowerCase() === decodedItemId?.toLowerCase()
    );
        ...
        <div className="pt-20 lgHome:px-20 mob470:px-2 mob560:px-3 md:px-10 bg-bgBeigeWhite">
          <div className="text-center py-10">
            ...
            <p className="text-gray-600">
              The vendor &quot;{decodedItemId}&quot; could not be found.
            </p>
          </div>
        </div>
      );
