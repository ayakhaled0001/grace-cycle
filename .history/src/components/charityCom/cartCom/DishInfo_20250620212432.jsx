    ...
    <>
      ...
      <div className="mt-10 border-t pt-10">
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-1/3">
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex flex-col">
                <div>
                  ...
                  <Star className="text-yellow-500" />
                  <Star className="text-yellow-500" />
                  <Star half className="text-yellow-500" />
                </div>
                ...
                <div key={rating} className="flex items-center gap-2">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5">
                    <div
                      ...
                      style={{ width: `${rating * 20}%` }} // Dummy percentage
                    ></div>
                  </div>
                </div>
              ))}
            ...
            <div className="mt-8">
              ...
              <div className="flex items-center gap-2 text-gray-300 mb-4">
                <StarBorder style={{ fontSize: "2.5rem" }} />
                <StarBorder style={{ fontSize: "2.5rem" }} />
                <StarBorder style={{ fontSize: "2.5rem" }} />
                <StarBorder style={{ fontSize: "2.5rem" }} />
                <StarBorder style={{ fontSize: "2.5rem" }} />
              </div>
              <button className="w-full border border-green-600 text-green-600 font-semibold py-2 rounded-lg hover:bg-green-600 hover:text-white transition">
                Write a review
              </button>
            </div>
          </div>
          ...
          <div className="w-full md:w-2/3 md:border-l md:pl-10">
            <h3 className="text-2xl font-bold font-nunitoBold text-lightBrownYellow mb-4">
              Reviews of others
            </h3>
            ...
            <button className="text-green-600 font-semibold mt-4 underline">
              See more reviews
            </button>
          </div>
        </div>
