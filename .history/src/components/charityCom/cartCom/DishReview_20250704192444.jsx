...
function DishReview({ contains, reviews, reviewsSummary, useVendorReviews }) {
  ...
  const vendorReviews = useSelector((state) => state.vendorDetails.reviews);
  const vendorReviewsSummary = useSelector(
    (state) => state.vendorDetails.reviewsSummary
  );

  const displayReviews = useVendorReviews ? vendorReviews : reviews;
  // const displayReviewsSummary = useVendorReviews ? vendorReviewsSummary : reviewsSummary;
