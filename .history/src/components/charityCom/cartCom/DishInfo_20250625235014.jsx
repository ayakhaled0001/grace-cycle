...
function DishInfo({
  ...
  // If this is a vendor page and we have vendor data, display vendor info
  if (isVendorPage && vendorData) {
    return (
      <>
        <p className="text-semilightGrey font-nunito py-2 mob470:py-3 mob560:py-3 md:py-5 px-2 mob470:px-3 mob560:px-4 md:px-0 text-xs mob470:text-sm mob560:text-sm md:text-base">
          Charity &gt;&gt; Vendors &gt;&gt; {vendorData.displayName}
        </p>
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 px-6 lg:px-8">
          ...
          <div className="w-full lg:w-5/12 flex justify-center">
            <img
              src={vendorData.picUrl}
              alt={vendorData.displayName}
          ...
          <div className="w-full lg:w-5/12 px-0 mob470:px-1 mob560:px-2 md:px-4 space-y-4">
            ...
            <h2 className="flex flex-col sm:flex-row text-xl mob470:text-2xl mob560:text-2xl md:text-3xl py-1 gap-2">
              <span className="break-words">{vendorData.displayName}</span>
            ...
            <div className="space-y-3">
              <div className="flex items-center pt-1 text-sm mob470:text-base mob560:text-base md:text-lg">
                ...
                <span className="ml-2">{vendorData.address}</span>
              </div>
              ...
              <div className="flex items-center pt-1 text-sm mob470:text-base mob560:text-base md:text-lg">
                ...
                <span
                  className={`ml-2 ${
                    vendorData.isOpen ? "text-green-600" : "text-red-600"
                  }`}>
              ...
              <div className="flex items-center pt-1 text-sm mob470:text-base mob560:text-base md:text-lg">
                ...
                <span className="ml-2">{vendorData.rating}/5</span>
              </div>
              ...
              {vendorData.logoUrl && (
                <div className="pt-3">
                  ...
                  <img
                    ...
                    alt={`${vendorData.displayName} logo`}
        ...
        <div className="py-4 mob470:py-5 mob560:py-5 px-6 lg:px-8">
          <h4 className="text-lightBrownYellow font-semibold font-nunitoBold text-lg mob470:text-xl mob560:text-xl md:text-2xl mb-3">
            About {vendorData.displayName}
          </h4>
          <p className="text-base mob470:text-lg mob560:text-lg md:text-xl leading-relaxed text-gray-700">
            {vendorData.displayName} is a trusted vendor in our charity program,
            located in {vendorData.address}. They have earned a rating of{" "}
            {vendorData.rating}/5 from our community and are currently{" "}
            {vendorData.isOpen ? "open" : "closed"} for business. This vendor is
      ...
      <div
        ...
        <div
          ...
          <div className="space-y-2 mob470:space-y-3 mob560:space-y-3">
            ...
            <Link
              to={`/CharityPage/vendor/${item.vName}`}
...
DishInfo.propTypes = {
  ...
  itemType: PropTypes.oneOf(["dish", "bag"]),
