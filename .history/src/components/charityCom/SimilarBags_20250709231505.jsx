      ...
      <div className="py-4 mob470:py-5 mob560:py-5 px-2 mob470:px-3 mob560:px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center py-8">
          <p className="text-gray-600 font-nunitoBold text-lg">
            Unable to load similar bags at the moment.
          </p>
        </div>
      </div>
    );
  ...
  if (!similarItems || similarItems.length === 0) {
    return (
      <div className="py-4 mob470:py-5 mob560:py-5 px-2 mob470:px-3 mob560:px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center py-8">
          <p className="text-gray-600 font-nunitoBold text-lg">
            No similar bags found at the moment.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="py-4 mob470:py-5 mob560:py-5 px-2 mob470:px-3 mob560:px-4 md:px-6 lg:px-8">
      ...
      <div>
        ...
        <div
          key={bag.id || index}
          className="flex flex-col sm:flex-row items-center rounded-xl p-4 w-full min-h-44 bg-semiDarkBeige box-border gap-4 my-3">
          <div className="flex flex-col sm:flex-row w-full h-full bg-cover bg-center gap-4">
            <div className="relative w-full sm:w-[40%] h-48 rounded-xl flex-shrink-0">
              <img
                src={bag.picUrl}
