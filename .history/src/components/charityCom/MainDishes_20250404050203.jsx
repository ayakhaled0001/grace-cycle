  ...
  return (
    <section className="w-10/12 mx-auto bg-semiDarkBeige my-5">
      ...
      <div className="m-3 w-3/12 font-sans border border-stone-700 rounded-xl overflow-hidden relative">
        <div className="flex absolute justify-between mx-2 left-0 right-0">
          <span className=" bg-semiDarkBeige">5+ left</span>
          <span className="flex  bg-semiDarkBeige">
            <img
              src="icons/star.svg"
              alt="star"
              className="w-5 text-center mx-1"
            />
            4.5
          </span>
        </div>
