...
import { fetchMainDishes, toggleFav } from "../../redux/FoodSlice";
...
function MainDishes() {
  ...
  return (
    <section className="w-[95%] mob470:w-[92%] mob560:w-[90%] md:w-10/12 mx-auto bg-semiDarkBeige my-3 mob470:my-4 mob560:my-5 flex flex-wrap justify-center py-3 mob470:py-4 relative rounded-lg font-nunitoBold">
      ...
      {mainDishes.map((food) => (
        <div
          className="m-2 mob470:m-3 w-full mob470:w-[48%] mob560:w-[47%] md:w-[31%] lg:w-[23%] border border-stone-700 rounded-xl relative"
          key={food.id}>
