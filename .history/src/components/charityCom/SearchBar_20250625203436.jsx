  ...
  return (
    <div className="flex flex-col gap-2 w-[95%] mob470:w-[92%] mob560:w-[90%] md:w-[85%] lg:w-[80%] xl:w-[75%] mx-auto mt-6 mob470:mt-8 mob560:mt-10 p-3 mob470:p-4 font-nunitoBold">
      <div className="flex flex-col mob470:flex-row items-center gap-3 mob470:gap-4">
        <div className="flex-6 flex items-center border border-lightGrey rounded-xl p-2 w-full mob470:w-[60%] lg:w-[50%] xl:w-[45%]">
        ...
        <button className="flex-2 flex items-center justify-center border border-lightGrey rounded-xl p-2 w-full mob470:w-[20%] lg:w-[15%] xl:w-[12%] text-sm mob470:text-base">
          <TuneIcon className="mr-2" /> Filter
        </button>
        <div className="flex-1 flex items-center justify-center border border-lightGrey rounded-xl p-2 h-10 w-full mob470:w-[5%] lg:w-[4%] xl:w-[3%] bg-btnsGreen text-white cursor-pointer">
          <img
        ...
        <div className="flex-1 flex items-center justify-center border border-lightGrey rounded-xl p-2 w-full mob470:w-[5%] lg:w-[4%] xl:w-[3%] bg-btnsGreen text-white cursor-pointer">
          <Favorite />
        </div>
      </div>
      <div className="flex items-center">
        <div className="rounded-md px-2 py-2 w-full mob470:w-[25%] lg:w-[20%] xl:w-[18%] bg-verylightGrey">
