...
const SimilarVendors = ({ vendors }) => {
  ...
  return (
    <div className="mb-8 px-2 mob470:px-3 mob560:px-4 md:px-6 lg:px-8 lg:w-10/12 lg:mx-auto">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-btnsGreen text-sm font-semibold hover:text-green-600 transition-colors">
                  View Details →
                </Link>
              </div>
            </div>
