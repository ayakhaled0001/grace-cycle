            ...
            <div className="p-4 w-6/12">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="bg-btnsGreen text-white px-3 py-2 rounded-lg text-sm font-semibold hover:bg-green-600 transition-colors inline-flex items-center justify-center">
