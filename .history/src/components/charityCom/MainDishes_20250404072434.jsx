      ...
      <div className="m-3 w-3/12 font-sans border border-stone-700 rounded-xl relative">
        ...
        <div className="p-2 relative">
          <div className="flex justify-between">
            {" "}
            <span className="shadow-xl rounded-full bg-semiDarkBeige  p-3 absolute -left-4 -top-6">
              <FavoriteOutlinedIcon
                className={` 
                ${isFav ? "text-btnsGreen" : "text-paleBarkYellow"}`}
              />
            </span>
            <span className="bg-semiBrightYellow py-3 px-1.5 rounded-full text-xl font-bold absolute right-1 -top-13">
              15%
            </span>
          </div>
