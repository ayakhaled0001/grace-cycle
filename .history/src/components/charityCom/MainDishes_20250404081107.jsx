...
function MainDishes() {
  ...
  return (
    <section className="w-10/12 mx-auto bg-semiDarkBeige my-5 grid grid-cols-3 relative">
      ...
      {mainDishes.map((food) => (
        <div
          className="m-3 w-11/12 font-sans border border-stone-700 rounded-xl relative h-auto"
          key={food.id}>
