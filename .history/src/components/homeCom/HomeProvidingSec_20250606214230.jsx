  ...
  return (
    <div className="flex relative lgHome:w-6/12 w-10/12 font-sans items-center justify-center text-center transition-opacity duration-500">
      {data.map((item, index) => (
        <div
          key={index}
          className={`bg-darkBiege absolute w-9/12 h-[410px] px-24 py-24 transition-opacity duration-500 rounded-3xl ${
    ...
    <section className="relative">
      ...
      <div className="flex w-12/12 h-96 justify-center relative bottom-0">
        <Section
          ...
          nextSlide={nextSlide}
        />
        <div className="w-4/12 flex relative z-30 hidden">
          <img
      ...
      <div className="absolute w-3/12 bg-darkGreen bottom-0 right-0 top-48 hidden"></div>
    </section>
  );
}
