...
function Section({ currentIndex, data, prevSlide, nextSlide }) {
  return (
    <div className="">
      ...
      <div>
        <WestIcon onClick={prevSlide} className="relative -bottom-1.5" />
        <EastIcon onClick={nextSlide} className="relative -bottom-1.5" />
      </div>
    </div>
  );
}
    ...
    <section className="">
      ...
      <div className="grid-cols-8 grid-rows-4">
        <div className="flex flex-col translate-y-3 col-start-1 col-end-5 relative  ">
          <div className="flex flex-col relative  w-8/12  font-sans items-center justify-center text-center transition-opacity duration-500 -z-10">
