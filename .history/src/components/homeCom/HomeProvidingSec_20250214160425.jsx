    ...
    <>
      <div className="flex flex-col relative w-6/12  font-sans items-center justify-center text-center transition-opacity duration-500 -z-10">
        {data.map((item, index) => (
          <div
            key={index}
            className={`bg-darkBiege absolute w-8/12 px-16 py-28 -z-10 transition-opacity duration-500 rounded-3xl  ${
...
function HomeProvidingSec() {
  ...
  return (
    <section>
      <div className="bg-darkGreen w-80 h-44 rounded-tr-full rounded-br-full z-20 absolute bottom-11"></div>
