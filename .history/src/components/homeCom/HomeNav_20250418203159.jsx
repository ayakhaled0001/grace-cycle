...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="absolute top-0 bottom-0 right-0 bg-[#fffcf685] minScreen:flex minScreen:flex-col z-40 ">
          <ul className="flex justify-between w-4/12 content-center ml-5 flex-col">
            <li className="m-auto">
              <NavLink to="/" className={`text-lg hover:text-lightBrownYellow`}>
                Home
              </NavLink>
