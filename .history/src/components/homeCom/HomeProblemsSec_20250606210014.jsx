...
function HomeProblemsSec() {
  return (
    <section className={`${styles} my-12 mx-10 bg-offWhite`}>
      <motion.h1
      ...
      <article className={`w-11/12 mx-auto flex lgHomejustify-between center`}>
        <motion.div
        ...
        <motion.aside
          ...
          className={`${styles.asideFlow} lgHome:w-6/12 w-11/12 my-12 flex flex-col justify-center `}>
