...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <>
      <nav
        className={`fixed z-50 ${backgroundColor} top-0 flex justify-around m-auto h-24 lgHome:py-5 w-full font-nunitoBold  minScreen:justify-between minScreen:px-3 `}>
