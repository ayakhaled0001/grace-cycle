...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="absolute top-0 bottom-0 right-0 bg-[#fffcf6c0] minScreen:flex minScreen:flex-col z-40 lgHome:hidden w-4/12">
          ...
          <div className="flex gap-3  h-12 minScreen:flex-col minScreen:my-6 minScreen:items-center ">
            <NavLink
              to="/signup"
              className="font-nunitoBold border-solid border-btnsGreen border-2 bg-btnsGreen
         w-6/12 text-white rounded-[11px] hover:bg-transparent hover:text-btnsGreen  transition-all text-center my-auto py-2">
