    ...
    <section className="bg-paleWhiteGrey p-16 text-center">
      ...
      <div className="flex justify-evenly text-left mt-10 ">
        <motion.div
          ...
          className="flex lgHome:w-3/12 w-80 bg-offWhite hover:text-offWhite hover:bg-btnsGreen p-5 rounded-2xl transition-all duration-500">
          <div>
        ...
        <motion.div
          ...
          className="flex items-between lgHome:w-3/12 w-80 bg-offWhite hover:text-offWhite hover:bg-btnsGreen p-5 rounded-2xl transition-all duration-500">
          <div>
            <img src="/public/icons/commaGroup.svg" alt="" />
