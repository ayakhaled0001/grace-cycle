    ...
    <>
      <div className="flex flex-col relative w-6/12  font-sans items-center justify-center text-center transition-opacity duration-500 -z-10">
        {data.map((item, index) => (
          <div
            key={index}
            className={`bg-darkBiege absolute w-9/12 px-24 py-24 -z-10 transition-opacity duration-500 rounded-3xl  ${
...
function HomeProvidingSec() {
  ...
  return (
    <section className="relative">
      <div className="bg-darkGreen w-64 h-36 rounded-tr-3xl rounded-br-3xl z-20 absolute top-20"></div>
      <div className="flex w-12/12 justify-center relative">
        <Section
          ...
          nextSlide={nextSlide}
        />
        <div className="w-4/12 flex relative overflow-hidden">
          <div className="absolute w-10/12  bg-darkGreen top-0 bottom-0 -right-40"></div>
