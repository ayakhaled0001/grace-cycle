...
function Section({ currentIndex, data, prevSlide, nextSlide }) {
  return (
    <div className="">
      {data.map((item, index) => (
        <div className=" col-start-1 col-end-5 flex flex-col relative  w-5/12 h-58 font-sans items-center justify-center text-center transition-opacity duration-500 -z-10">
          <div
            key={index}
  ...
  return (
    <section className="">
      ...
      <div className="grid-cols-8 grid-rows-4">
        ...
        <img src="homeMedia/person1.png" alt="" className="col-span-3 col-st" />
      </div>
    </section>
  );
}
