...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <>
      <nav
        className={`fixed z-50 ${backgroundColor} top-0 flex justify-around m-auto h-24 lgHome:py-5 minScreen:py-0 minScreen:h-16 w-full font-nunitoBold  minScreen:justify-between minScreen:px-3 `}>
      ...
      {isOpen && (
        <div className="absolute top-0 bottom-0 right-0 bg-[#fffcf6c0] minScreen:flex minScreen:flex-col z-40 lgHome:hidden w-4/12 my-auto ">
          <div className="sticky top-40">
            <ul className="flex justify-between  content-center  flex-col items-center ">
              <li className="">
                <NavLink
                  to="/"
                  className={`text-lg hover:text-lightBrownYellow`}>
