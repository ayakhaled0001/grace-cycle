        ...
        <aside className={`${styles.asideFlow} w-6/12 `}>
          <div className={`${styles.asideItem} flex relative justify-end`}>
            <img
              ...
              width="120"
              height="120"
              className={`${styles.asideItemImg} px-5 py-5 bg-btnsGreen rounded-full absolute -left-0.5 top-0 bottom-0`}
            />
            <div
              className={`bg-lightBiege text-center font-sans w-10/12 py-2 px-2 rounded-full`}>
