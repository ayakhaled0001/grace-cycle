...
function Section({ currentIndex, data, prevSlide, nextSlide }) {
  return (
    <div className="flex flex-col relative  font-sans items-center justify-center text-center transition-opacity duration-500">
      {data.map((item, index) => (
        <div
          key={index}
          className={`bg-darkBiege absolute w-12/12 h-96 px-24 py-24 transition-opacity duration-500 rounded-3xl ${
