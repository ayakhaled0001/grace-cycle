...
function HomeMainSec() {
  return (
    <main className="w-10/12 mx-auto mt-16 mb-12 flex justify-center lgHome:justify-between pb-14 pt-12">
      <motion.section
        ...
        className="w-11/12 lgHome:w-8/12 py-8 flex items-center flex-col lgHome:items-start">
