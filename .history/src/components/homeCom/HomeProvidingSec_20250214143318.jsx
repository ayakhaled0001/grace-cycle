...
function Section({ currentIndex, data }) {
  return (
    <div className="  flex flex-col font-sans items-center justify-center text-center transition-opacity duration-500 relative">
      {data.map((item, index) => (
        <div
          key={index}
          className={`bg-darkBiege absolute w-6/12 p-10 transition-opacity duration-500 ${
