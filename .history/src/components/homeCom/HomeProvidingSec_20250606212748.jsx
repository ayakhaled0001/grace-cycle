...
function Section({ currentIndex, data, prevSlide, nextSlide }) {
  return (
    <div className="flex flex-col relative  w-9/12 font-sans items-center justify-center text-center transition-opacity duration-500">
      {data.map((item, index) => (
        <div
          key={index}
...
function HomeProvidingSec() {
  ...
  return (
    <section className="relative">
      ...
      <div className="flex w-12/12 h-96 justify-center items-center relative bottom-0">
        <Section
