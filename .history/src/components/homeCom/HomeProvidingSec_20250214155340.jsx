    ...
    <>
      <div className="flex flex-col relative w-6/12 h-58 font-sans items-center justify-center text-center transition-opacity duration-500 -z-10">
        {data.map((item, index) => (
          <div
            key={index}
            className={`bg-darkBiege absolute w-10/12 h-60 px-16 py-16 transition-opacity duration-500 rounded-3xl inset-0 ${
...
function HomeProvidingSec() {
  ...
  return (
    <section>
      <div className="bg-darkGreen w-80 h-44 rounded-tr-full rounded-br-full relative z-20"></div>
