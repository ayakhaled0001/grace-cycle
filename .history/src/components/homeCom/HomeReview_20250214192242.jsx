...
function HomeReview() {
  return (
    <section className="bg-paleWhiteGrey p-16">
      ...
      <div className="flex w-3/12 bg-offWhite hover:bg-btnsGreen p-5 rounded-2xl transition-all duration-1000">
        <div>
          ...
          <div className="flex gap-x-3 items-center">
            ...
            />
            <div>
              <p className="hover:text-offWhite p-0 transition-all duration-1000">
                Mohamed Soliman
              </p>
              <div>
