...
function HomeNav({ backgroundColor }) {
  ...
  return (
    <nav
      className={`fixed z-50 ${backgroundColor} top-0 flex justify-around m-auto h-24 py-7 w-full font-nunitoBold  minScreen:justify-between minScreen:mx-3`}>
      <div className="w-2/12">
        <img src="logo.png" alt="grace cycle" className="w-40" />
      </div>
      <ul className="flex justify-between w-4/12 content-center ml-5 minScreen:hidden">
        <li className="m-auto">
