function AboutMainSec() {
  return (
    <main className="relative flex flex-col align-middle content-center ">
      <h1 className="font-otoma text-center text-4xl my-8">About Us</h1>
      <img className="" src="about/aboutmain.png" alt="" />
      <div className="p-12 font-sans font-medium text-xl w-10/12 bg-darkBiege rounded-2xl absolute bottom-5 left-auto">
        <p>
