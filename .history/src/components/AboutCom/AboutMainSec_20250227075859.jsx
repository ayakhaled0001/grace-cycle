function AboutMainSec() {
  return (
    <main>
      <h1 className="font-otoma text-center text-6xl my-12">About Us</h1>

      <img className="" src="about/aboutmain.png" alt="" />
      <div className="p-16 font-sans font-medium text-2xl w-10/12 bg-darkBiege rounded-2xl relative bottom-24 mx-auto ">
