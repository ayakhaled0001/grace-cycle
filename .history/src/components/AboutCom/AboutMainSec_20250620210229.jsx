function AboutMainSec() {
  return (
    <main className="mt-20 md:mt-40">
      <h1 className="font-otoma text-center text-4xl md:text-6xl my-8 md:my-12">
        About Us
      </h1>
      ...
      <img
        ...
        alt=""
      />
      <div className="p-8 md:p-16 font-sans font-medium text-xl md:text-3xl w-11/12 md:w-10/12 bg-darkBiege rounded-2xl relative bottom-12 md:bottom-24 mx-auto ">
