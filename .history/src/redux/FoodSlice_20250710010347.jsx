        ...
        if (isAdded) {
          ...
          if (!existingItem) {
            ...
            if (foodItem) {
              ...
              // If not found in regular arrays, it might be from foodListing
              // We'll add a placeholder that will be updated when the full data is available
              ...
              state.favoriteFoods.push(placeholderItem);
            }
          }
        } else {
