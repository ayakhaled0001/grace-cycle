      ...
      <div className="flex justify-center">
        ...
        <div className="">
          ...
          <p className="py-1">
            ...
            flavor. Simple seasoning like salt, pepper, and lemon often
            highlights the fish&apos;s natural taste, though marinades can add
            complexity. Crispy skin provides a nice contrast. It&apos;s a
            versatile main course that pairs well with various side dishes.
          </p>
        </div>
      </div>
    </div>
