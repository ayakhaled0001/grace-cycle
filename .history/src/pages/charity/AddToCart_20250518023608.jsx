    ...
    <div className="pt-20 px-20 bg-bgBeigeWhite ">
      ...
      <div>
        ...
        <p>
          ...
          the fish's natural taste, though marinades can add complexity. Crispy
          skin provides a nice contrast. It's a versatile main course that pairs
          well with various side dishes.
        </p>
      </div>
    </div>
  );
